...
Group-B topic discussions, Google search, docs.python.org, stackoverflow.com"""
...
def print_top(filename):
    ...
    word_count = create_word_dict(filename)
    items = sorted(
        word_count.items(), key=lambda v: (v[1], v[0]), reverse=True)
